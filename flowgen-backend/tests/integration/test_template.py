...
def test_get_prompt_template_success():
    ...
    template = get_prompt_template("browser")
...
def test_apply_prompt_template():
    ...
    messages = apply_prompt_template("browser", test_state)
...
@pytest.mark.parametrize("prompt_name", ["browser", "coder", "coordinator", "planner"])
